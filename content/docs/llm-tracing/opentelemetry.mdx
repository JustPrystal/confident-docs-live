...
span.SetAttributes(
    ...
    attribute.String("confident.llm.attributes.input", []string{`{"role": "system", "content": "You are a helpful assistant."}`, `{"role": "user", "content": "What is the capital of France?"}`}),
...
span.setAttributes({
    ...
    "confident.agent.attributes.input": `{"input": input}`,
    "confident.agent.attributes.output": `{"output": input}`,
});
```
...
span.SetAttributes(
    ...
    attribute.String("confident.agent.attributes.input", `{"input": input}`),
    attribute.String("confident.agent.attributes.output", `{"output": input}`),
...
span.SetAttribute("confident.agent.attributes.input", `{"input": input}`);
span.SetAttribute("confident.agent.attributes.output", `{"output": input}`);
```
...
span.setAttributes({
    ...
    "confident.tool.attributes.input_parameters": `{"input": input}`,
    "confident.tool.attributes.output": `{"output": input}`,
});
```
...
span.SetAttributes(
    ...
    attribute.String("confident.tool.attributes.input_parameters", `{"input": input}`),
    attribute.String("confident.tool.attributes.output", `{"output": input}`),
...
span.SetAttribute("confident.tool.attributes.input_parameters", `{"input": input}`);
span.SetAttribute("confident.tool.attributes.output", `{"output": input}`);
```
...
span.setAttributes({
    ...
    "confident.retriever.attributes.top_k": 10,
    "confident.retriever.attributes.chunk_size": 10,
});
```
...
span.SetAttributes(
    ...
    attribute.String("confident.retriever.attributes.embedding_input", input),
    attribute.String("confident.retriever.attributes.retrieval_context", []string{"asd", "asd"}),
    attribute.Int("confident.retriever.attributes.top_k", 10),
    attribute.Int("confident.retriever.attributes.chunk_size", 10),
...
span.SetAttribute("confident.retriever.attributes.embedding_input", input);
span.SetAttribute("confident.retriever.attributes.retrieval_context", ["asd", "asd"]);
span.SetAttribute("confident.retriever.attributes.top_k", 10);
span.SetAttribute("confident.retriever.attributes.chunk_size", 10);
```
